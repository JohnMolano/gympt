...
import 'package:gympt/screens/workouts/bloc/workouts_bloc.dart';
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(child: ClipRRect(borderRadius: BorderRadius.circular(15), child: Image.network(workout.image, fit: BoxFit.fill))),
                  ],
                ),
              ),
            );
